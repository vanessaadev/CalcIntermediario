        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <br>
                            <p><strong>Parabéns! <?php echo $NomeUsuario ?> Você chegou ao final do Modulo 01 do curso Calc Intermediário e Avançado. Teste os seus conhecimentos respondendo a Avaliação do Modulo 01. <br> Boa sorte e até o próximo Modulo!</strong></p>
                ...
                <div class="text-center">
                    ...
                    <a href="http://cursos.egp.ce.gov.br/mod/quiz/view.php?id=370" class="btn btn-outline-success" role="button" aria-pressed="true"><i class="fa fa-tasks"></i> Realização Avaliação </a>
                </div>
